...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import glmnet_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("78c6b45d-5eaf-5d68-bcfb-a5a2cb06c27f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "glmnet", artifacts_toml) for e in artifacts["glmnet"]]
...
if best_platform === nothing
    @debug("Unable to load glmnet; unsupported platform $(triplet(platform_key_abi()))")
else
