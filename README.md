# `glmnet_jll.jl` (v2.0.13+0)

[![deps](https://juliahub.com/docs/glmnet_jll/deps.svg)](https://juliahub.com/ui/Packages/glmnet_jll/UMGvH?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ba4a95ded001e9d0a4a97b6fdb5c4179692fac08/G/glmnet/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `glmnet_jll.jl` have been built from these sources:

* git repository: https://github.com/cran/glmnet.git (revision: `6de9dbc14c515d08999a7af77ff01e44218a4f4e`)

## Platforms

`glmnet_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `glmnet_jll.jl`:
